    ...
    <Container>
      ...
      <>
        ...
        <ContentsContainer>
          ...
          <ButtonBox>
            <ButtonItem>
              <RightIconButton active={false} title="보험 가입 증명원" onPress={() => console.log(1)} />
            </ButtonItem>
            <ButtonItem>
              <RightIconButton active={false} title="보험증권" onPress={() => console.log(1)} />
            </ButtonItem>
            <ButtonItem>
              <RightIconButton active={false} title="보험약관" onPress={() => console.log(1)} />
            </ButtonItem>
          </ButtonBox>
          <HelperText>
      ...
      <ContentsContainer>
        ...
        <HelperText style={{ marginTop: 10 }}>
          <Typhograph type="NOTO" color="GRAY" size={12}>
            * 입금확인 이후 계약은 최종적으로 완료되며, 회원가입 시 등록하신 이메일로 통합청약서 및 증권이 발송됩니다.
          </Typhograph>
