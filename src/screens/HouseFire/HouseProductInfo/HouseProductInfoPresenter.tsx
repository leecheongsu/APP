...
type HouseProductInfoPresenterTypes = {
  state: HouseFireStateTypes;
  onChangeState: (name: HouseFireStateName, value: any) => void;
  toggleCollapsed: (name: 'col1' | 'col2' | 'col3' | 'col4') => void;
  collapsed: {
    col1: boolean;
    col2: boolean;
    col3: boolean;
...
function HouseProductInfoPresenter({
  state,
  onChangeState,
  toggleCollapsed,
  collapsed,
...
}: HouseProductInfoPresenterTypes) {
  return (
    <Container>
      <ContentsContainer>
        <TextBox>
                ...
                <>
                  <CollapseItemBody>
                    ...
                    <CollapseTextBox>
                      ...
                      <Typhograph type="NOTO" color="BLUE" size={10} lineheight={2} style={{ marginTop: 10 }}>
                        · "과실로 인해 타인 소유의 물건에 손해를 가한 자는 2천만 원 이하의 벌금에 처한다." (형법 170조,
                        171조)
                      </Typhograph>
                    </CollapseTextBox>
                  </CollapseItemBody>
...
export default HouseProductInfoPresenter;
